...
INSERT INTO TBL_COLEGIO (ID_Colegio, Nombre_Colegio, Codigo_DANE, Email, Telefono, Direccion_Colegio, FK_ID_Barrio) VALUES
    ...
    (22, 'IED Nueva Constitucion', '111001093157', 'cednuevaconstituci10@educacionbogota.edu.co', '6014353457', 'Kr 107B No. 74B-31', 2),
    (23, 'IED General Santander', '111001013447', 'cedgeneralsantande10@educacionbogota.edu.co', '6014310575', 'Cl 68B No. 124-20', 1),
    (24, 'IED Guillermo Leon Valencia', '111001012394', 'cedguillermoleonv10@educacionbogota.edu.co', '6014361066', 'Cl 75 No. 74A-40', 27),
    (25, 'IED Jorge Gaitan Cortes', '111001012424', 'cedjorgegaitancor10@educacionbogota.edu.co', '6012510255', 'Cl 70 No. 80-45', 27),
...
INSERT INTO tbl_persona (ID_Persona, Num_Doc_Persona, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Fecha_Nacimiento, Estado_Persona) VALUES 
    (100, '1010101101', 'Fortress', NULL, 'Educa', NULL, '2005-08-26', '1');
...
INSERT INTO tbl_datos_adicionales (ID_Datos_Adicionales, Email, Telefono, FK_ID_Parentesco, FK_ID_Tipo_Iden, FK_ID_Persona, FK_ID_Genero, FK_ID_Grupo_Preferencial, FK_ID_Estrato, FK_ID_Barrio, Estado_Datos_Adicionales) VALUES 
    (100, 'fortress.educa@gmail.com', '3213397085', '15', '1', '100', '1', '1', '1', '16', '1');
...
INSERT INTO tbl_usuario (ID_Usuario, Nombre_Usuario, Contraseña_Hash, Ultimo_Cambio_Contraseña, Ultimo_Login, Intentos_Fallidos, Fecha_Creacion, Doble_Factor_Activo, MFA_Fecha_Configuracion, MFA_Secret, MFA_Secret_Temp, Notificaciones_Email, Notificaciones_Navegador, Aceptacion_Terminos, FK_ID_Persona, FK_ID_Rol, Estado_Usuario) VALUES 
    (100, 'fortress.educa@gmail.com', '$argon2id$v=19$m=65536,t=3,p=4$CbNaBHYhF5D+Llo3F4gYLQ$EqZN3qrgTsEUQwe7ZpSgTBSBAOijwkUw+M42Gqmkoio', NULL, '2026-04-17 02:06:16', '0', '2026-04-17 02:01:41', 'INACTIVE', NULL, NULL, NULL, '0', '0', 'ACCEPTED', '100', '4', '1');


-- ----------------------------------------------------------------------------------------------------------------------------------------------------
-- USUARIO PRUEBA: USUARIO ADMIN N°2
-- -----------------------------------------------------

INSERT INTO tbl_persona (ID_Persona, Num_Doc_Persona, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Fecha_Nacimiento, Estado_Persona) VALUES 
    (101, '1010101111', 'Fortress', NULL, 'Educa Admin', NULL, '2005-08-27', '1');

INSERT INTO tbl_datos_adicionales (ID_Datos_Adicionales, Email, Telefono, FK_ID_Parentesco, FK_ID_Tipo_Iden, FK_ID_Persona, FK_ID_Genero, FK_ID_Grupo_Preferencial, FK_ID_Estrato, FK_ID_Barrio, Estado_Datos_Adicionales) VALUES 
    (101, 'fortress.educa.ad@gmail.com', '3213397086', '15', '1', '101', '1', '1', '1', '16', '1');

INSERT INTO tbl_usuario (ID_Usuario, Nombre_Usuario, Contraseña_Hash, Ultimo_Cambio_Contraseña, Ultimo_Login, Intentos_Fallidos, Fecha_Creacion, Doble_Factor_Activo, MFA_Fecha_Configuracion, MFA_Secret, MFA_Secret_Temp, Notificaciones_Email, Notificaciones_Navegador, Aceptacion_Terminos, FK_ID_Persona, FK_ID_Rol, Estado_Usuario) VALUES 
    (101, 'fortress.educa.ad@gmail.com', '$argon2id$v=19$m=65536,t=3,p=4$CbNaBHYhF5D+Llo3F4gYLQ$EqZN3qrgTsEUQwe7ZpSgTBSBAOijwkUw+M42Gqmkoio', NULL, '2026-04-17 02:06:16', '0', '2026-04-17 02:01:41', 'INACTIVE', NULL, NULL, NULL, '0', '0', 'ACCEPTED', '101', '4', '1');
...
INSERT INTO tbl_persona (ID_Persona, Num_Doc_Persona, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Fecha_Nacimiento, Estado_Persona) VALUES 
    (1199, '1019762928', 'Emerson', 'Daniel', 'Caicedo', 'Cobos', '2000-01-01', 1);

INSERT INTO tbl_datos_adicionales (ID_Datos_Adicionales, Email, Telefono, FK_ID_Parentesco, FK_ID_Tipo_Iden, FK_ID_Persona, FK_ID_Genero, FK_ID_Grupo_Preferencial, FK_ID_Estrato, FK_ID_Barrio, Estado_Datos_Adicionales) VALUES 
    (1199, 'edcaicedoc@sanmateo.edu.co', '3213397584', '13', '1', '1199', '1', '3', '3', '18', 1);

INSERT INTO tbl_usuario (ID_Usuario, Nombre_Usuario, Contraseña_Hash, Ultimo_Cambio_Contraseña, Ultimo_Login, Intentos_Fallidos, Fecha_Creacion, Doble_Factor_Activo, MFA_Fecha_Configuracion, MFA_Secret, MFA_Secret_Temp, Notificaciones_Email, Notificaciones_Navegador, Aceptacion_Terminos, FK_ID_Persona, FK_ID_Rol, Estado_Usuario) VALUES 
    (1199, 'edcaicedoc@sanmateo.edu.co', '$argon2id$v=19$m=65536,t=3,p=4$CbNaBHYhF5D+Llo3F4gYLQ$EqZN3qrgTsEUQwe7ZpSgTBSBAOijwkUw+M42Gqmkoio', '2026-04-14 11:44:39', '2026-04-16 06:13:17', '0', '2026-03-30 23:07:59', 'INACTIVE', NULL, NULL, NULL, '0', '0', 'ACCEPTED', '1199', '3', '1');

-- ----------------------------------------------------------------------------------------------------------------------------------------------------
-- USUARIO PRUEBA: USUARIO TÉCNICO N°2
-- -----------------------------------------------------

INSERT INTO tbl_persona (ID_Persona, Num_Doc_Persona, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Fecha_Nacimiento, Estado_Persona) VALUES 
    (1200, '1019762929', 'Fortress', NULL, 'Educa Tech', NULL, '2000-01-01', 1);

INSERT INTO tbl_datos_adicionales (ID_Datos_Adicionales, Email, Telefono, FK_ID_Parentesco, FK_ID_Tipo_Iden, FK_ID_Persona, FK_ID_Genero, FK_ID_Grupo_Preferencial, FK_ID_Estrato, FK_ID_Barrio, Estado_Datos_Adicionales) VALUES 
    (1200, 'fortress.educa.tech@gmail.com', '3213397585', '13', '1', '1200', '1', '3', '3', '18', 1);

INSERT INTO tbl_usuario (ID_Usuario, Nombre_Usuario, Contraseña_Hash, Ultimo_Cambio_Contraseña, Ultimo_Login, Intentos_Fallidos, Fecha_Creacion, Doble_Factor_Activo, MFA_Fecha_Configuracion, MFA_Secret, MFA_Secret_Temp, Notificaciones_Email, Notificaciones_Navegador, Aceptacion_Terminos, FK_ID_Persona, FK_ID_Rol, Estado_Usuario) VALUES 
    (1200, 'fortress.educa.tech@gmail.com', '$argon2id$v=19$m=65536,t=3,p=4$CbNaBHYhF5D+Llo3F4gYLQ$EqZN3qrgTsEUQwe7ZpSgTBSBAOijwkUw+M42Gqmkoio', '2026-04-14 11:44:39', '2026-04-16 06:13:17', '0', '2026-03-30 23:07:59', 'INACTIVE', NULL, NULL, NULL, '0', '0', 'ACCEPTED', '1200', '3', '1');
...
INSERT INTO tbl_persona (ID_Persona, Num_Doc_Persona, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Fecha_Nacimiento, Estado_Persona) VALUES 
    (8, '1524524213', 'Luis', 'Alejandro', 'Narvaez', 'Talavera', '2015-11-19', 1);

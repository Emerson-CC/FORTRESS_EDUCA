...
1. Creación del sistema para la visualización y seguimiento de tickets por parte del usuario:
    - Modificación del archivo ticket_status.html. Ahora solo muestra la lista de tickets creados.

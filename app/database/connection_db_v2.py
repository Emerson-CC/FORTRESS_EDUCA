"""Archivo anterior: app/database/connection_db_v2.py
Función actual: wrapper de conexión a la base de datos MySQL.
...
from new_version.app.settings import Config_DB
